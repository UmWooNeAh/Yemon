          ...
          child: Column(children: [
            Row(
              ...
              AnimatedContainer(
                ...
                child: editManagement.checkMultipleSelect() ? InkWell(
                  onTap:(){
                    showDialog(context: context, builder: (context){
                      return AlertDialog(
                        elevation: 0,
                        title: Text("정산의 삭제하면 다시 되돌릴 수 없습니다\n선택한 정산을 삭제하시겠습니까?",
                          style: TextStyle(
                            fontSize: 15,
                            fontWeight: FontWeight.w600,
                            color: basic[4],
                ...
                Row(
                  ...
                  children: [
                    InkWell(
                      onTap: (){
                        showDialog(context: context, builder: (context){
                          return AlertDialog(
                            elevation: 0,
                            title: const Text("정산의 이름을 수정합니다",
                              style: TextStyle(
                                fontSize: 15,
                                fontWeight: FontWeight.w700,
                              ),
                    ...
                    VerticalDivider(width: 20,thickness: 2,color: basic[2],endIndent:10,indent: 10,),
                    InkWell(
                      onTap:(){
                        showDialog(context: context, builder: (context){
                          return AlertDialog(
