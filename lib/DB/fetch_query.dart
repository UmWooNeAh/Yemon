  ...
  Future<List<ReceiptItem>> fetchReceiptItems(Database db, String rcpId) async {
    ...
    dbReceiptItems.forEach((dbReceiptItem) async {
      ...
      List<Map> res = await db.rawQuery(
          'SELECT SP.settlementPaperId, SP.memberName FROM (SettlementItem as SI INNER JOIN (SELECT settlementPaperId, memberName from SettlementPaper) as SP ON SI.settlementPaperId = SP.settlementPaperId) WHERE SI.receiptItemId = ?',
